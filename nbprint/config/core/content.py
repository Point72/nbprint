...
frontmatter:
    ...
    dedication: content that appears on the dedication page. for physical books, this corresponds to the page after the copyright page.
    table_of_contents: content that appears on the table of contents page. for physical books, this corresponds to the page after the dedication page.
    frontmatter: content that appears before the main body of the report/book. typically includes preface, foreword, introduction, etc.
middlematter:
    middlematter: content that forms the main body of the report/book. typically includes chapters/sections.
    middlematter_separators: if middlematter is a list of lists of content, we can treat the first content in each sublist as a separator (e.g., chapter title page).
endmatter:
    ...
    endmatter: content that appears after the main body of the report/book. typically includes bibliography, glossary, colophon, etc.
